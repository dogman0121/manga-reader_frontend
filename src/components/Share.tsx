import { Box, OutlinedInput, SvgIcon, Typography, useTheme } from "@mui/material";
...
export default function Share({open, onClose, link}: {link: string, open: boolean, onClose: () => void}) {
    const theme = useTheme();
